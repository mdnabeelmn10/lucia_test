...
def validate_login(request):
    ...
    email = request.data.get('form_fields[email]') or request.data.get('email') or request.POST.get('email')
    password = request.data.get('form_fields[password]') or request.data.get('password') or request.POST.get('password')
