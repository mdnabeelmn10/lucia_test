...
def ai_router(request):
    ...
    if charity_name or tin and message == "":
    ...
    # --------------------------------------------------------------------------
    # (b) Filter intent → use previous matches
    # --------------------------------------------------------------------------
    # if intent == "filter":
    ...
    #     # Call your AI filter logic directly
    ...
    # You will read the JSON list and return only those entries that match the intent.Incase there aren't any matching ones you can ge 
    ...
    #         # 🧩 Build context: combine previous query, top charity names, and user intent
    #         base_name = ""
    #         if last_matches:
    ...
    #             # fallback to session history if no matches stored
    ...
    #             # Tag all new results as unverified
    ...
    #                     "You can try specifying the full organization name."
    #                 )
